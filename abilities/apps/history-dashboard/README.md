...
- `dev` starts Next.js in dev mode with hot reload inside Docker.
...
- In `dev` mode, the repository is mounted read-write at `/workspace` and a persistent Docker volume backs `node_modules`.
